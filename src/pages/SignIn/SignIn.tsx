                ...
                <Box className="container">
                    ...
                    <Box className="signin-box">
                        ...
                        <Box className="box-image">
                            ...
                            <img className="img" src="https://besthqwallpapers.com/Uploads/25-5-2020/134632/thumb2-4k-black-stone-background-cracked-stone-texture-stone-textures-grunge-backgrounds.jpg" alt="login-image" />
